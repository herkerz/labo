...
ajustar_valores <- function(dataset )
{
  
  data_url <- fread("https://raw.githubusercontent.com/herkerz/labo/main/src/zulip/data/eco_data.csv")
  
  columnas_ajustables <- colnames(dataset)[sapply(dataset, is.double)]
  columnas_ajustables_pesos <- !columnas_ajustables %like% "dolar"
